...
const Home: React.FC = () => {
  useEffect(() => {
    ...
    const elementsToAnimate = document.querySelectorAll('.feature-card, .access-card, .hero-stats') as NodeListOf<HTMLElement>;
        ...
        <section id="login-cta" className="login-cta">
          ...
          <div className="cta-content">
            ...
            <div className="cta-actions">
              ...
              <Link to="/signup" className="btn-outline btn-xl btn">Đăng ký ngay</Link>
            </div>
